...
2. Featured Astronomy Dictionary Cards
3. Visual Media Section

🔹 AI Assistance Disclosure: I used ChatGPT to help generate CSS layout design and animations of the buttons

🔹 Learning Reflection: I learned how to design a landing page and enhance it with well-structured content and smooth animations to improve user experience. The most challenging part was learning how to code the animations and fully customize the website to achieve a cohesive and polished design.
...
2. Featured Astronomy Dictionary Cards
3. Visual Media Section
4. Multi-page navigation (Landing → Login → Signup)
5. Consistent UI styling across pages

🔹 AI Assistance Disclosure: I used chatgpt to help me with linking and designing the login ang sign up page.
